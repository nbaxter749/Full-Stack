...
def show_one_business(id):#bellow this they change to get id and 404 need to find id bit in review
    data_to_return =  [ business for business in businesses if business['id'] == id ]
    return make_response( jsonify(  data_to_return[0] ), 200 )
#some chnages bellow to add a business start of post method
